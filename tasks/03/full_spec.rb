describe "Graphics" do
  ...
  describe "Canvas" do
    ...
    it "returns a rendering via render_as with external renderers" do
      ...
      make_canvas(800, 600).render_as(null_renderer).should eq 'canvas: 800x600'
    end
  ...
  describe "Renderers" do
    describe "Base" do
      it "requires an argument during initialization" do
        expect { Graphics::Renderers::Base.new }.to raise_error(ArgumentError)
      end

      it "can be created with a canvas" do
        Graphics::Renderers::Base.new(double)
      end

      it "raises a NotImplementedError in its render method" do
        expect { Graphics::Renderers::Base.new(double).render }.to raise_error(NotImplementedError)
      end
    end
  ...
  context "shapes" do
    ...
    describe "Line" do
      ...
      context "rasterize_on" do
        ...
        it "draws lines with a small slope" do
        ...
        it "draws lines with a significant slope, with swapped ends" do
    ...
    describe "Rectangle" do
      ...
      context "rasterize_on" do
        ...
        it "draws rects defined with their bottom left and top right points" do
          canvas = make_canvas 10, 5
        ...
        it "draws rects with a zero height as a line" do
        ...
        it "draws rects with a zero width and height as a single point" do
          canvas = make_canvas 3, 3
